...
namespace WebApp
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IHostApplicationLifetime applicationLifetime, IClusterBuilder clusterBuilder)
        {
            ...
            applicationLifetime.ApplicationStarted.Register(clusterBuilder.StartWebClusterNode);
